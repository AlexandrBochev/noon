...
const bgMotion = {
  animate: {
    background: [
      'linear-gradient(0deg, rgb(21 19 19 / 1), rgb(21 19 19 / 1), rgb(21 19 19 / 1), rgb(21 19 19 / 0))',
      'linear-gradient(180deg, rgb(21 19 19 / 1), rgb(21 19 19 / 1), rgb(21 19 19 / 1), rgb(21 19 19/ 0))',
      'linear-gradient(360deg, rgb(21 19 19 / 1), rgb(21 19 19 / 1), rgb(21 19 19 / 1), rgb(21 19 19 / 0))',
    ],
  },
  transition: { repeat: Infinity, duration: 4 },
}

const Button3 = ({ children, arrow, onClick }: ButtonProps) => {
  return (
    <m.button
      { ...btnMotion }
      className="relative px-[30%] md:px-[98.1%] md:py-[14.66%] border rounded-full border-transparent group z-0"
      onClick={ onClick }
    >
      ...
      <div className={`flex items-center text-sm lg:text-base text-nowrap z-20 ${FONT_STYLES_SILVER}`}>
          { children }
          { arrow && <Arrow /> }
      </div>
    </m.button>
